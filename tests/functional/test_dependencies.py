...
class TestProject:
    ...
    def test_load_contracts_with_config_override(self, temp_project):
        ...
        data = {
            "name": "FooBar",
            "local": f"{temp_project.path}",
            "config_override": override,
        }
        temp_project.dependencies.install(**data)
        proj = temp_project.dependencies.get("foobar", "local")
