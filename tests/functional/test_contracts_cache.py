...
def test_get_non_proxy_caches_negative_result_until_deleted(chain, mocker):
    ...
    assert get_proxy_info.call_count == 1
    assert chain.contracts.proxy_infos.get_entry(address).exists
