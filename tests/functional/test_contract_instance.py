...
def test_get_nested_array_fixed_fixed(solidity_contract_instance):
    actual = solidity_contract_instance.getNestedArrayFixedFixed()
    assert actual == [[1,2], [3, 4], [5, 6]]

def test_get_nested_array_dynamic_fixed(solidity_contract_instance, owner):
    actual = solidity_contract_instance.getNestedArrayDynamicFixed()
    assert actual == [[1,2], [3, 4], [5, 6]]

def test_get_nested_array_fixed_dynamic(solidity_contract_instance, owner):
    actual = solidity_contract_instance.getNestedArrayFixedDynamic()
    assert actual == [[0], [0, 1], [0, 1, 2]]

def test_get_nested_array_mixed_dynamic(solidity_contract_instance, owner):
    actual = solidity_contract_instance.getNestedArrayMixedDynamic()
    assert len(actual) == 5
...
def test_get_nested_address_array(solidity_contract_instance, sender):
    actual = solidity_contract_instance.getNestedAddressArray()
    assert len(actual) == 2
