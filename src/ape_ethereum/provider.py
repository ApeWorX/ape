...
from ape.api import BlockAPI, ProviderAPI, ReceiptAPI, TraceAPI, TransactionAPI
...
class Web3Provider(ProviderAPI, ABC):
        ...
        **kwargs,
        ...
        try:
            ...
            raise TransactionNotFoundError(
                transaction_hash=txn_hash, error_message=str(err)
            ) from err
    ...
    def _get_logs(self, filter_params, raw=True) -> List[Dict]:
        ...
        return self.make_request("eth_getLogs", [filter_params])
